...
import auth from "../config/firebase"//firebase file was in another folder so i use ..

function Signup() {
    const [email, setEmail] = useState('');
    const [password, setPassword] = useState('');//give always 6 numbers for password
    ...
    const handleSubmit = (e) => {
        ...
        if (password !== confirmPassword) {
            setError('Passwords do not match');//Error means it throw the error message
            return;
        }
        //or save the email & pass in firebase
